<html>
<body>
	<button style="background-color:black "><a href="admin1st.html" style="color:white">Back</a></button><div style="margin-top:10px; style : center" >
<style >
	body{
...
echo "Details of player with player_id $player_id are";
