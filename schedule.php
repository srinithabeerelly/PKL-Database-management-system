...
<body>
	...
	<form action="retrieve_sdetails.php" method="post"><table><tr align="center">
	...
	<table align="center">
		...
		$con=mysqli_connect("localhost","root","","kabaddi");
		$query="SELECT match_number,city,date,team_1,team_2,venue 
		FROM schedules 
		INNER JOIN venue  
		ON schedules.venue = venue.venue_name ";
		$result=mysqli_query($con,$query);
		if(mysqli_num_rows($result)>0)
		{
			while ($row=mysqli_fetch_assoc($result)) {
